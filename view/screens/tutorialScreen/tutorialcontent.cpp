    ...
    switch (currentStep) {
        case 1:
            ...
            painter->drawText(
                ...
                Qt::AlignCenter | Qt::TextWordWrap,
                "Welcome to Helheim Rising - by Team Shaheer");
            ...
            painter->drawText(
                ...
                Qt::AlignCenter | Qt::TextWordWrap,
                "Your aim is to destroy all the vikings, preventing them to reach 30 in the game.\n"
                "You can achieve this by spawning as many turrets as u can");
            break;
        case 2:
            ...
            painter->drawText(
                ...
                "When the game starts vikings begin to spawn, trying to reach the end of the path.\n"
                "There are different vikings waves during a match, each one with different statistics.\n"
                "If a viking reaches the end of the path you loose life. When your life reaches 0 the game is over.\n\n"
                "You have some initial game credits. Use them to strategically place turrets in order to defeat vikings.\n"
                "When a viking dies you earn some credit.\n\n"
                "If you manage to destroy all vikings you win!");
            break;
        case 3:
            ...
            painter->drawText(
                ...
                Qt::AlignVCenter | Qt::TextWordWrap,
                "Path cells:\n"
                "the cells where the vikings will walk");
        ...
        case 5:
            ...
            paintTurretInfo(
                ...
                "weak-turret",
                "Little Turret",
                "Mob Turret may seem difficult for a begginer, but Barbaric vikings know how to handle them.\n"
        ...
        case 6:
            ...
            paintTurretInfo(
                ...
                "mitra-turret",
                "Flame of Surtr",
                "Some able vikings may escape the template's hell. But someone will be constantly hit by it's difficult trajectory.",
                QString(
                    "Cost: %1\n"
                    "Max targets: %2\n"
                    "Radius: %3\n"
        ...
        case 7:
            ...
            paintTurretInfo(
                ...
                "granade-turret",
                "Valhalla Turret",
                "A valkyrie will strike hard the poor viking that encounters it. Fortunately it doesn't happen often.",
                QString(
                    "Cost: %1\n"
                    "Max targets: %2\n"
                    "Radius: %3\n"
        ...
        case 8:
            ...
            paintTurretInfo(
                ...
                "combo-turret",
                "Axe turret",
                "These are a problem for a few vikings. But the ones with mobility can dodge them"
                " will be penalised more and more with each attack.",
                QString(
                    "Cost: %1\n"
                    "Max targets: %2\n"
                    "Radius: %3\n"
        ...
        case 9:
            ...
            paintTurretInfo(
                ...
                "split-turret",
                "Formation Turret",
                "Let's be honest: Formation is not so hard. When vikings join forces there's nothing that"
                " can stop them!",
                QString(
                    "Cost: %1\n"
                    "Max targets: %2\n"
        ...
        case 10:
            ...
            paintTurretInfo(
                ...
                "slowtime-turret",
                "Iceking Turret",
                "This turret will slow with ice"
                " waste a lot of vikings' time.",
                QString(
                    "Cost: %1\n"
                    "Max targets: %2\n"
                    "Radius: %3\n"
