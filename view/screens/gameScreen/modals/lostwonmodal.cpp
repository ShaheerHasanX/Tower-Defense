...
void LostWonModal::paintContent(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget) {
    ...
    font.setFamily("Press Start 2P - Anonymous Shaheer");
    font.setBold(true);
    ...
    QString title = "YOU LOST BROO";
    QString corps = "Vikings Reached Valhalla!\n\nIt seems that your skill is not so good...\n\n Better learn from Sir Waseem";

    if (_lostWon == model::Game::State::Won) {
        title = "YOU WIN";
        corps = "You defeated all the Vikings!\n\nIt seems Sir Waseem taught you well!";
    }
