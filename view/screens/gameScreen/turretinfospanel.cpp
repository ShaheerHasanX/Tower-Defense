...
if (_show) {
    switch (_turretType) {
        case model::TurretType::WeakTurret:
            paintTitle(painter, "weak-turret", "Little Turret");
        ...
        case model::TurretType::MitraTurret:
            paintTitle(painter, "mitra-turret", "Flame of Surtr");
        ...
        case model::TurretType::GranadeTurret:
            paintTitle(painter, "granade-turret", "Valhalla Turret");
        ...
        case model::TurretType::ComboTurret:
            paintTitle(painter, "combo-turret", "Axe Turret");
        ...
        case model::TurretType::SplitTurret:
            paintTitle(painter, "split-turret", "Formation Turret");
        ...
        case model::TurretType::SlowTimeTurret:
            paintTitle(painter, "slowtime-turret", "Iceking Turret");
