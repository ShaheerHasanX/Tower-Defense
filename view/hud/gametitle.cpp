...
void GameTitle::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget) {
    ...
    painter->drawText(QRect(0, 0, 1200, 110), Qt::AlignHCenter | Qt::AlignBottom, "Helhiem Rising");

    font.setPixelSize(30);
    painter->setFont(font);

    painter->drawText(QRect(0, 130, 1200, 40), Qt::AlignHCenter, "by Shaheer, Muhib and Humayun");
}
